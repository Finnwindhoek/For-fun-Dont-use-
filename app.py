...
def load_assets():
    ...
    try:
        ...
        # Unpack the new imputation values as well
        return assets['model'], assets['scaler'], assets['columns'], assets['imputation']
    except FileNotFoundError:
        st.error("Asset file 'sales_classifier.joblib' not found. Please ensure it's in the same directory as the app.")
        return None, None, None, None
    except KeyError:
        st.error("The asset file is corrupted or invalid. Please recreate it and ensure it contains 'model', 'scaler', 'columns', and 'imputation' keys.")
        return None, None, None, None
